  ...
  const sections = [
    {
      ...
      content: ` Martechbiz marketing ("we," "our," or "us") uses cookies and similar technologies to enhance user experience, analyze site performance, and support marketing campaigns. By continuing to use our website, you agree to the placement of cookies on your device, unless you choose to disable them.
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-gray-700 text-[15px]">
                    ...
                    <p>Website: <a href="https://martechbiz.com" className="text-[#386861] hover:underline font-medium">https://martechbiz.com</a></p>
                  </div>
                </div>
              </div>
            </div>
